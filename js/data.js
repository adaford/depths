...
export const MONSTERS = {
  m_rat:    { id: 'm_rat',    name: 'Giant Rat',      emoji: '🐀', hp: 13, ap: 3, def: 0, pool: 'easy', nap: 0.3,
    moves: [{ t: 'melee', name: 'Bite', emoji: '🦷', dmg: 5, ap: 2 }] },
  m_bat:    { id: 'm_bat',    name: 'Cave Bat',       emoji: '🦇', hp: 10, ap: 4, def: 0, pool: 'easy', nap: 0.2,
    moves: [{ t: 'melee', name: 'Swoop', emoji: '🌬️', dmg: 4, ap: 2 }] },
  m_slime:  { id: 'm_slime',  name: 'Slime',          emoji: '🦠', hp: 18, ap: 2, def: 1, pool: 'easy', nap: 0.7,
    moves: [{ t: 'melee', name: 'Engulf', emoji: '💧', dmg: 6, ap: 2 }] },
  m_gob:    { id: 'm_gob',    name: 'Goblin',         emoji: '👺', hp: 15, ap: 3, def: 0, pool: 'easy', nap: 0.4,
    moves: [{ t: 'melee', name: 'Shiv', emoji: '🗡️', dmg: 5, ap: 2 }, { t: 'guard', name: 'Hide', emoji: '🛡️', block: 4, ap: 1 }] },
  m_spider: { id: 'm_spider', name: 'Cave Spider',    emoji: '🕷️', hp: 11, ap: 3, def: 0, pool: 'easy', nap: 0.5,
    moves: [{ t: 'melee', name: 'Venom Bite', emoji: '☠️', dmg: 3, ap: 2, psn: [2, 2] }] },
  m_skel:   { id: 'm_skel',   name: 'Skeleton',       emoji: '💀', hp: 22, ap: 3, def: 1, pool: 'med', nap: 0.5,
    moves: [{ t: 'melee', name: 'Slash', emoji: '⚔️', dmg: 7, ap: 2 }, { t: 'guard', name: 'Bone Wall', emoji: '🦴', block: 6, ap: 1 }] },
  m_zomb:   { id: 'm_zomb',   name: 'Zombie',         emoji: '🧟', hp: 30, ap: 2, def: 0, pool: 'med', nap: 0.8,
    moves: [{ t: 'melee', name: 'Rend', emoji: '🩸', dmg: 8, ap: 2 }] },
  m_cult:   { id: 'm_cult',   name: 'Cultist',        emoji: '🧙', hp: 18, ap: 3, def: 0, pool: 'med', nap: 0.3,
    moves: [{ t: 'rng', name: 'Hex Bolt', emoji: '🔮', dmg: 6, rng: 4, ap: 2 }, { t: 'rage', name: 'Dark Chant', emoji: '💢', atk: 2, ap: 2 }] },
  m_viper:  { id: 'm_viper',  name: 'Pit Viper',      emoji: '🐍', hp: 16, ap: 4, def: 0, pool: 'med', nap: 0.4,
    moves: [{ t: 'melee', name: 'Fang', emoji: '☠️', dmg: 4, ap: 2, psn: [2, 2] }] },
  m_orc:    { id: 'm_orc',    name: 'Orc Brute',      emoji: '👹', hp: 26, ap: 3, def: 1, pool: 'med', nap: 0.5,
    moves: [{ t: 'melee', name: 'Cleave', emoji: '🪓', dmg: 9, ap: 2 }] },
  m_ogre:   { id: 'm_ogre',   name: 'Ogre',           emoji: '🧌', hp: 38, ap: 3, def: 1, pool: 'elite', nap: 0.6,
    moves: [{ t: 'melee', name: 'Smash', emoji: '💥', dmg: 11, ap: 2 }, { t: 'rage', name: 'Fury', emoji: '💢', atk: 2, ap: 1 }] },
  m_wraith: { id: 'm_wraith', name: 'Wraith',         emoji: '👻', hp: 30, ap: 4, def: 0, pool: 'elite', nap: 0.3,
    moves: [{ t: 'rng', name: 'Soul Rip', emoji: '🌫️', dmg: 7, rng: 3, ap: 2 }] },
  m_golem:  { id: 'm_golem',  name: 'Stone Golem',    emoji: '🗿', hp: 44, ap: 2, def: 2, pool: 'elite', nap: 0.85,
    moves: [{ t: 'melee', name: 'Slam', emoji: '🪨', dmg: 10, ap: 2 }, { t: 'guard', name: 'Harden', emoji: '🛡️', block: 8, ap: 1 }] },
  m_whelp:  { id: 'm_whelp',  name: 'Dragon Whelp',   emoji: '🐲', hp: 13, ap: 3, def: 0, pool: 'minion', nap: 0.5,
    moves: [{ t: 'melee', name: 'Nip', emoji: '🦷', dmg: 5, ap: 2 }] },
  m_dragon: { id: 'm_dragon', name: 'Ancient Dragon', emoji: '🐉', hp: 86, ap: 4, def: 2, pool: 'boss', nap: 0.35,
